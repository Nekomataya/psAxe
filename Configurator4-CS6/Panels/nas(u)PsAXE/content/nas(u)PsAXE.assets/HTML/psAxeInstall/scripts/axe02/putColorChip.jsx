...
//	Window
var w=nas.GUI.newWindow("dialog",nas.localize({en:"make color chip",ja:"色指定チップを作る"}),3,6);
//	TEXT
 w.tx1	=nas.GUI.addEditText(w,nas.localize({en:"(Untitled)",ja:"(名称未定)"}),0,0,3,1);

 w.lb1	=nas.GUI.addStaticText  (w ,"BOX" ,0 ,1 ,1.5 ,1).justify="right";
	w.tx2	=nas.GUI.addEditText(w,boxNum,1.5,1,1,1);
	w.lb1u	=nas.GUI.addStaticText  (w ,nas.localize({en:"boxes",ja:"個"}) ,2.5 ,1 ,0.5 ,1);
